...
class RedShiftData:
    ...
    def execute_query(self):
        """ A method that executes a query in the redshift query editor. Can be used to create tables all query data.

        Returns:
            json: A json string is returned containing the success or failure of the query. The actual results of the query are not returned
        """
