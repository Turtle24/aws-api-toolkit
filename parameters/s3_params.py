...
class CreateBucket:
    Bucket: str
    GrantFullControl: Optional[str] = 'string'
    GrantRead: Optional[str] = 'string' 
    GrantReadACP: Optional[str] = 'string'
    GrantWrite: Optional[str] = 'string'
    GrantWriteACP: Optional[str] = 'string'
    ObjectLockEnabledForBucket: Optional[bool] = False
    ACL: Optional[str] = 'authenticated-read'
    CreateBucketConfiguration: Optional[str] = 'af-south-1'
